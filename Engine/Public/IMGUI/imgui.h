...
struct ImGuiIO
{
    ...
    // Keyboard/Gamepad NavMeshAgent options
    ...
    bool        ConfigNavCursorVisibleAlways;   // = false          // NavMeshAgent cursor is always visible.
...
inline ImVec2& operator*=(ImVec2& lhs, const ImVec2& rhs)       { lhs.x *= rhs.x; lhs.y *= rhs.y; return lhs; }
inline ImVec2& operator/=(ImVec2& lhs, const ImVec2& rhs)       { lhs.x /= rhs.x; lhs.y /= rhs.y; return lhs; }
inline bool    operator==(ImVec2& lhs, ImVec2& rhs) { return lhs.x == rhs.x && lhs.y == rhs.y; }
inline bool    operator!=(ImVec2& lhs, ImVec2& rhs) { return lhs.x != rhs.x || lhs.y != rhs.y; }
// ImVec4 operators
